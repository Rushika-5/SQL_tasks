...
values(09,'Namisha',765482,'namisha@gmail.com','F','Ahemadnagar')
 

select * from customer where cust_id =1

update customer set gender = 'm' where  cust_id =1

update customer set custphoneno = 567890321 where custname = 'Ganesh'

update customer set cust_id = 89 where cust_id =1

update customer set gender = 'f' where  cust_id = 5  and custemailid = 'rani123@gmail.com'

update customer set custaddress = 'Pune' where custname = 'Sarika' or gender = 'F'
...
update Employees set age = 30 where  firstname = 'Priya';

update Employees set empid = 90  where designation = 'Project Manager'

--select * from Employees where age =28 and lastname = 'Iyer'

update Employees set age = 50 where age =28 and lastname = 'Iyer'

update Employees set designation = 'Team Lead',salary = 750000.00 where empid = 2;

update Employees set designation = 'Junior Associate' where  salary < 50000 OR age > 25;
...
update Doctor set age = 34 where doct_id = 2 and gender = 'F'

update Doctor set age = 34 where doct_id = 2 or gender = 'F'

update Doctor set name = 'Nilima' where citypincode = 440034

update Doctor set phoneno = 98765 where doct_id= 8

update Doctor set age = 39 where age > 20
...
-- (6, 'Moby Dick', 'Herman Melville', 18.75, 'An Willam allegorical story of Captain Ahab''s obsession.', '2023-06-25'),
...
UPDATE book SET price = 17.99 WHERE book_id = 5
UPDATE book SET author_name = 'Anonymous' WHERE b_name = 'Ulysses'
UPDATE book SET b_name = 'The Power of Subconscious Mind' where author_name = 'Markus Zusak'
UPDATE book SET price = 20.50,book_description = 'Updated edition with commentary.'WHERE book_id = 10;
UPDATE book SET price = 21.50,author_name = 'Agatha Christie' where b_name = 'Life of Pi'
...
update college set c_id = 501 where c_name = 'Lata Mangeshkar'

update college set professor_name = 'Dr.Ram Meghe',c_name = 'Prasad Institute of Medical Sciences' where student_name = 'Nikita G'

update college set department = 'M.tech' where c_name = 'Pandav College Engg'or c_id = 12583

update college set attendance = 'Present' where attendance = 'Absent'

update college set student_name = 'Sarthak' where c_id = 31131  and department = 'Chemical'
...
update hospital set address = 'Mumbai' where h_id = 2 and h_name = 'Bhute hospital'

update hospital set totalbeds = 300  where mobileno = 98765 or h_name = 'Bhute Integrity hospital'

update hospital set h_name = 'Patil Hospital'where pincode = 440009  and address = 'Nanded' and totalbeds = 10

update hospital set mobileno= 98740 where mobileno = 98744 or h_name = 'Sant Gajanan hospital' or pincode = 44067

update hospital set pincode = 77777 where (mobileno = 98744 and h_name = 'Bhute hospital')or pincode = 440077
...
update department set d_address = 'Pimpri Chinchwad Pune'  where dept_id = 11

update department set d_salary = 800000.000, deptno = 511,d_name = 'Strategy'where deptno = 120 and d_address = 'Noida'

update department set d_name = 'Automation Tester' where d_name = 'Quality Assurance'

update department set deptcontactno = 071605 where d_name = 'Development'

update department set deptno = 876 where dept_id = 1
...
update orders set o_address = 'Pimpri Chinchwad Pune'  where o_id = 3

update orders set orderdesc = 'Jwellery Set' where o_name = 'Necklace Set'or order_status = 'Pending'

update orders set totalamount = 50.0  where o_name = 'Necklace set'

update orders set o_name = 'Cloth set'  where (o_address = 'Pune' and order_status = 'Received') or totalamount < 50

update orders set totalamount = 40.0  where o_id = 10 
...
update student set city = 'Jalgaon' where gender = 'M'


update student set assessment = 'Complete' where gender = 'F'and s_name = 'Priya Joshi'

update student set s_contactnumber = 2715648 where s_id = 890   or gender = 'F'

update student set  s_contactnumber = 2715648 where s_id = 890   or gender = 'F' or s_name = 'Anaya Rao'

update student set s_contactnumber = 2715648,s_name = 'Shantu',city= 'Pusad' where gender = 'M'
...
update products set p_id = 201 where pname = 'Smartphone'

update products set p_id = 222,pname= 'Tablet',price = 500000.0 where pname = 'LCD Lighter'

update products set p_color= 'White' where p_color = 'Black'

update products set quantityperproduct = 30 where p_color= 'Grey'and pname = 'Printer' and manufacturing_date = '2024-03-18'

update products set price = 60000.0 where pname = 'Camera'
